        ...
        <article key={score.id} className="grid min-w-0 gap-3 rounded-lg border bg-white p-3 shadow-sm transition hover:border-blue-200 hover:shadow-md xl:grid-cols-[240px_1fr_220px] xl:items-center">
          <div className="min-w-0">
            <div className="flex min-w-0 items-center gap-2">
              <span className={index < 3 ? "flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-700 text-xs font-semibold text-white" : "flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-slate-900 text-xs font-semibold text-white"}>
                {index + 1}
              </span>
              <div className="min-w-0">
          ...
          <div className="flex min-w-0 items-center justify-between gap-3 xl:flex-col xl:items-end xl:justify-start xl:gap-1.5">
            <div className="min-w-0 xl:text-right">
              <div className="flex items-center gap-1.5 xl:justify-end">
                <span className="text-lg font-semibold leading-none text-blue-700">{moneyFormat.format(score.estimated_payment)}</span>
