...
export const RULE_PARAM_LABELS: Record<string, string> = {
  ...
  require_same_regional: "Exigir que o cluster seja da mesma regional",
...
export const RULE_PARAM_HELP: Record<string, string> = {
  ...
  require_same_regional: "Quando ligado, O.S. ou logins de regionais diferentes nunca formam o mesmo alerta, mesmo que estejam geograficamente próximos.",
