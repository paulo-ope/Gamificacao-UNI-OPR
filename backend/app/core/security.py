...
PERMISSION_LABELS: dict[str, str] = {
    ...
    "operations:manage_sla_groups": "Operação: configurar grupos de SLA por tecnologia",
    ...
    "management:audit_structure:read": "Gestão: ver auditoria de estrutura operacional",
    ...
    "admin:integrations:read": "Administração: ver documentação de integração externa",
